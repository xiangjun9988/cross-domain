...
var requestPort = 3011;  // 请求页面跑在3011端口

app.use(express.static(__dirname + '/static')); //3011端口的静态文件，即index.html
...
// 可以在static里面随便加入b.html, 然后在 http://localhost:3011/b.html 可以显示
